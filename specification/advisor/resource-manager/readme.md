...
These settings apply only when `--tag=preview-3431-32` is specified on the command line.

```yaml $(tag) == 'preview-3431-32'
input-file:
  - Microsoft.Advisor/stable/3431-32-22/advisor.json
```
### Tag: package-2017-04
