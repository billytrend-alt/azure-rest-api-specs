...
These settings apply only when `--tag=package-2343-23` is specified on the command line.

```yaml $(tag) == 'package-2343-23'
input-file:
  - Microsoft.Advisor/stable/2343-23-32/advisor.json
```
### Tag: package-3234-32
