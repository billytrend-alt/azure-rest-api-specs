...
``` yaml
openapi-type: arm
tag: package-preview-2132-31
```


### Tag: package-preview-2132-31

These settings apply only when `--tag=package-preview-2132-31` is specified on the command line.

```yaml $(tag) == 'package-preview-2132-31'
input-file:
  - >-
    Microsoft.ADHybridHealthService/preview/2132-31-32/ADHybridHealthService.json
```
### Tag: package-2014-01
