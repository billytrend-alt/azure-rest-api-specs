...
These settings apply only when `--tag=preview-2018-06` is specified on the command line.

```yaml $(tag) == 'preview-2018-06'
input-file:
  - Microsoft.Batch/stable/2018-06-01/BatchManagement.json
```
### Tag: package-2017-09
