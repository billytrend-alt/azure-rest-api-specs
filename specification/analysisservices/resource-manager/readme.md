...
These settings apply only when `--tag=package-5354-34` is specified on the command line.

```yaml $(tag) == 'package-5354-34'
input-file:
  - Microsoft.AnalysisServices/stable/5354-34-23/analysisservices.json
```
### Tag: package-2017-08
