...
These settings apply only when `--tag=package-4321-43` is specified on the command line.

```yaml $(tag) == 'package-4321-43'
input-file:
  - Microsoft.AnalysisServices/stable/4321-43-43/analysisservices.json
```
### Tag: package-2017-08
